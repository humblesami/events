...
function getHTMLMediaElement(mediaElement, config) {
    ...
    var is_first = $('#videos-container>.media-container').length == 0;
    if(is_first)
    {
        $(mediaElementContainer).addClass('self');
    }
    ...
    function adjustControls() {
        ...
        // console.log(volumeControl.style.marginTop, 13)
        // if (times < 10) {
        //     times++;
        //     setTimeout(adjustControls, 1000);
        // } else times = 0;
...
function getAudioElement(mediaElement, config) {
    ...
    if (config.buttons && config.buttons.indexOf('record-audio') == -1) {
        slider.style.width = parseFloat(slider.style.width) + 41 +'px';
    ...
    function adjustControls() {
        ...
        console.log(mediaControls.style.marginTop, 160);
        if (times < 10) {
            times++;
            setTimeout(adjustControls, 1000);
        } else times = 0;
