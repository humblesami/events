...
var appRoutes = [
    ...
    { path: 'reset-password/:token', component: _components_setpassword_setpassword_component__WEBPACK_IMPORTED_MODULE_23__["SetpasswordComponent"] },
...
/* harmony import */ var _roster_roster_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../roster/roster.component */ "./src/components/roster/roster.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MeetingDetailsComponent = /** @class */ (function () {
    function MeetingDetailsComponent(route, router, httpService, sanitizer, ss, modalService) {
        var _this = this;
        this.route = route;
        this.router = router;
        this.httpService = httpService;
    ...
    MeetingDetailsComponent.prototype.open = function (meeting_id) {
        var modalRef = this.modalService.open(_roster_roster_component__WEBPACK_IMPORTED_MODULE_6__["RosterComponent"]);
...
var ProfilesummaryComponent = /** @class */ (function () {
    ...
    ProfilesummaryComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./profilesummary.component.css */ "./src/components/profilesummary/profilesummary.component.css"), __webpack_require__(/*! ../profiledetails/profiledetails.css */ "./src/components/profiledetails/profiledetails.css"), __webpack_require__(/*! ../roster/roster.component.css */ "./src/components/roster/roster.component.css")]
        }),
...
var RosterComponent = /** @class */ (function () {
    function RosterComponent(httpService, modalService, activeModal, socketService) {
        this.httpService = httpService;
        this.modalService = modalService;
        this.activeModal = activeModal;
        this.socketService = socketService;
