...
function showCalendarEvnetPopup(result)
{
    ...
    function calLocation(result){
        ...
        result.location += result.country_state + ',';
...
var SocketService = /** @class */ (function () {
    ...
    SocketService.prototype.init_route = function (url) {
        ...
        this.current_model = undefined;
        this.current_id = undefined;
        this.active_parent_notification = {};
...
var ChatComponent = /** @class */ (function () {
    ...
    ChatComponent.prototype.ngOnInit = function () {
        ...
        $('body').on('mouseup', '#toggle_notification_btn', function (e) {
            togglerelated(e, this, '.container.notification-list');
        });
    };
...
var CommentsComponent = /** @class */ (function () {
        ...
        var on_comments_list = function (result) {
            try {
                for (var item in result) {
                    if (result[item].subtype_id) {
                        if (result[item].subtype_id === 1) {
                            result[item].reply = false;
                            obj_this.comments.push(result[item]);
                        }
                        else if (result[item].subtype_id === 2) {
                            obj_this.notes.push(result[item]);
                        }
                    }
                }
            }
    ...
    CommentsComponent.prototype.save_comment_key_up = function (e) {
        var obj_this = this;
        if (e.keyCode == 13 && !e.shiftKey) {
            e.preventDefault();
            obj_this.save_comment(null);
        }
    };
    __decorate([
...
var MessengerComponent = /** @class */ (function () {
    ...
    MessengerComponent.prototype.onUserSelected = function (messages) {
        ...
        setTimeout(function () {
            var emojiPicker = new window["EmojiPicker"]({
