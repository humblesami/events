...
var MessengerComponent = /** @class */ (function () {
    ...
    MessengerComponent.prototype.onUserSelected = function (messages) {
        ...
        $(".msg_card_body").scroll(function () {
            var height = Math.floor(0.3 * ($(document).height() - $(".msg_card_body").height()));
