...
/* harmony import */ var _components_votingdetails_votingdetails_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ../components/votingdetails/votingdetails.component */ "./src/components/votingdetails/votingdetails.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _components_votingdetails_votingdetails_component__WEBPACK_IMPORTED_MODULE_37__["VotingdetailsComponent"]
            ],
            providers: [
            ...
            entryComponents: [_components_messageicon_messageicon_component__WEBPACK_IMPORTED_MODULE_36__["MessageiconComponent"], _components_messenger_messenger_component__WEBPACK_IMPORTED_MODULE_35__["MessengerComponent"], _components_chat_chat_component__WEBPACK_IMPORTED_MODULE_15__["ChatComponent"], _components_comments_comments_component__WEBPACK_IMPORTED_MODULE_34__["CommentsComponent"], _components_document_document_component__WEBPACK_IMPORTED_MODULE_27__["DocumentComponent"]],
        })
    ], AppModule);
    return AppModule;
}());
...
var MessengerComponent = /** @class */ (function () {
    ...
    MessengerComponent.prototype.sendMessage = function () {
        ...
        if (window['odoo']) {
            input_data.content = input_data.content.replace(/\/meeting_point\/static\/meetvue\/assets/g, "assets");
        }
    ...
    MessengerComponent.prototype.update_emjoi_urls = function (messages) {
        ...
        if (window['odoo']) {
            messages.forEach(function (element) {
                var message_body = element.content;
                message_body = message_body.replace(/assets\/img/g, "meeting_point/static/meetvue/assets/img");
                element.content = obj_this.sanitizer.bypassSecurityTrustHtml(message_body);
            });
        }
        else {
            messages.forEach(function (element) {
...
/***/ "./src/components/votingdetails/votingdetails.component.css":
/*!******************************************************************!*\
  !*** ./src/components/votingdetails/votingdetails.component.css ***!
  \******************************************************************/
/*! no static exports found */
...
var VotingdetailsComponent = /** @class */ (function () {
    function VotingdetailsComponent(httpService, route) {
        this.httpService = httpService;
        this.route = route;
    }
    VotingdetailsComponent.prototype.get_voting_data = function () {
        var req_url = '/voting/details';
        var voting_id = this.route.snapshot.params.id;
        var input_data = { voting_id: voting_id };
        var obj_this = this;
        var voting_data = '';
        var success_cb = function (voting_data) {
            if (!voting_data) {
                console.log("invalid data", voting_data);
                return;
            }
    ...
    VotingdetailsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./votingdetails.component.css */ "./src/components/votingdetails/votingdetails.component.css")]
        }),
        __metadata("design:paramtypes", [_app_http_service__WEBPACK_IMPORTED_MODULE_1__["HttpService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
