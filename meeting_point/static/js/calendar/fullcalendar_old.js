...
var GlobalEmitter = /** @class */ (function () {
    ...
    GlobalEmitter.prototype.handleClick = function (ev) {
        ...
        $('.fc-day-grid-container:first').css({
            'overflow': 'auto',
            'height': 'auto'
        });
        var last_row = $('.fc-row.fc-week:last');
        if(last_row.length && last_row.length > 0 )
        {
            var other_month_days = last_row.find('thead:first td.fc-other-month');
            if(other_month_days.length && other_month_days.length == 7)
            {
                last_row.hide();
            }
            else
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        titleHtml =
            '<span class="fc-title" id="' + eventDef.id + '">' +
...
//addition by Asfand
ViewRegistry_1.defineView('basicYear', {
    type: 'basic',
    duration: { year: 1 }
