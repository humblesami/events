...
class child(models.Model):
    ...
    is_anticipated = fields.Selection([('yes','Yes'),('no','No')],string=" Is child receiving therapy/counseling")
    ...
    other_needs = fields.Text('Others')
    willing = fields.Selection([('willing','Willing'),('not_willing','Not Willing')])
    daily_rate = fields.Char('Daily Rate ($)')
    clothing_rate = fields.Char("Quarterly Clothing Rate ($)")
    emergency_clothing = fields.Char("Emergency Clothing ($)")
    child_name = fields.Char("Child's Name")
    date_placement = fields.Date("Date of Placement")
    placement_length = fields.Char("Length of Placement")
    care = fields.Selection([('a','Foster Care'),('b','Therapeutic Foster Care')])
    foster_parent_address = fields.Text("Address")
    foster_parent_name = fields.Char("Name")
