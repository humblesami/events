    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meeting', models.ForeignKey(blank=True, default=False, on_delete=django.db.models.deletion.CASCADE, to='meetings.Event')),
                ('topic', models.ForeignKey(blank=True, default=False, on_delete=django.db.models.deletion.CASCADE, to='meetings.Topic')),
            ],
        ),
        migrations.CreateModel(
            name='VotingType',
