...
#     @http.route('/leave_management_custom/leave_management_custom/', auth='public')
#     def index(self, **kw):
#         return "Hello, world"

#     @http.route('/leave_management_custom/leave_management_custom/objects/', auth='public')
#     def list(self, **kw):
...
#     @http.route('/leave_management_custom/leave_management_custom/objects/<model("leave_management_custom.leave_management_custom"):obj>/', auth='public')
